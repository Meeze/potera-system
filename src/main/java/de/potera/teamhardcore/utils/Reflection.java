...
public class Reflection {
    ...
    private static final Class<?> craftPlayerClass = getOBCClass("entity.CraftPlayer");
    private static final Class<?> entityPlayerClass = getNMSClass("EntityPlayer");
    private static final Class<?> playerConnectionClass = getNMSClass("PlayerConnection");
    ...
    public static int getMinecraftVersion(Player p) {
        Object playerConnection = getFromField(getField(entityPlayerClass, "playerConnection"),
                invoke(p, getMethod(craftPlayerClass, "getHandle")));
        Object networkManager = getFromField(getField(playerConnectionClass, "networkManager"), playerConnection);
        return (Integer) invoke(networkManager, getMethod(networkManagerClass, "getVersion"), new Object[0]);
    }
